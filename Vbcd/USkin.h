...
ProtoType		:
	BOOL USkinInit(  LPCSTR lpszUserName    // user name
	  LPCSTR lpszRegCode     // sn
	  LPCSTR lpszFileName    // uskin file name
	);
Parameters		:
	lpszUserName 
...
*/
USKIN_API BOOL  __stdcall USkinInit(LPCSTR lpszUserName,LPCSTR lpszRegCode,LPCSTR lpszFileName);
...
ProtoType		:
	BOOL USkinLoadSkin(  LPCSTR lpszFileName    // USkin file name
	);
Parameters		:
	lpszFileName 
...
Return values	:
		If the function succeeds, the return value is nonzero. If the function fails, the return value is zero 
*/
USKIN_API BOOL  __stdcall USkinLoadSkin(LPCSTR lpszFileName);
...
ProtoType		:
	BOOL USkinLoadSkinFromResource(  HMODULE hInstance    // handle of module
		  LPCSTR lpszResourceName     // resource name
		LPCSTR lpszResourceType     // resouce type
	);
Parameters		:
	hInstance 
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinLoadSkinFromResource(HMODULE hInstance,LPCSTR lpszResourceName,LPCSTR lpszResourceType);
...
ProtoType		:
	HUSKIN USkinOpenSkinData(  LPCSTR lpszSkinObjectName    // custom define skin object name
	);
Parameters		:
	lpszSkinObjectName 
...
*/
USKIN_API HUSKIN __stdcall USkinOpenSkinData(LPCSTR lpszSkinObjectName);
...
ProtoType		:
	BOOL USkinGetBool(  HUSKIN hUSkin    // The handle to the uskin object
		LPCSTR lpszSkinPropName    // property name
		BOOL* lpValue    // 
	);
Parameters		:
	hUSkin 
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetBool(HUSKIN hUSkin,LPCSTR lpszSkinPropName,BOOL* lpValue);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetInt(HUSKIN hUSkin,LPCSTR lpszSkinPropName,int* lpValue);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetDWORD(HUSKIN hUSkin,LPCSTR lpszSkinPropName,DWORD* lpValue);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetDouble(HUSKIN hUSkin,LPCSTR lpszSkinPropName,double* lpValue);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero 
*/
USKIN_API BOOL __stdcall USkinGetString(HUSKIN hUSkin,LPCSTR lpszSkinPropName,LPTSTR lpString,UINT nMaxSize);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetEnumString(HUSKIN hUSkin,LPCSTR lpszSkinPropName,LPTSTR  lpString,UINT nMaxSize);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetEnumValue(HUSKIN hUSkin,LPCSTR lpszSkinPropName,DWORD* lpValue);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetFont(HUSKIN hUSkin,LPCSTR lpszSkinPropName,LOGFONT* lpLogFont);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetColor(HUSKIN hUSkin,LPCSTR lpszSkinPropName,COLORREF* lpColor);
...
ProtoType		:
	BOOL USkinDrawSkinImageSection(  HUSKIN hUSkin    // Handle to the USkin object
		LPCSTR lpszSkinPaintOptionResName    // custom skinpaintoption property name
		LPCSTR lpszSkinImageSectionResName    // custom skinimagesection property name
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero 
*/
USKIN_API BOOL __stdcall USkinDrawSkinImageSection(HUSKIN hUSkin,LPCSTR lpszSkinPaintOptionResName,LPCSTR lpszSkinImageSectionResName,HDC hDC,LPRECT lpDrawRect);
...
ProtoType		:
	BOOL USkinDrawText(  HUSKIN hUSkin    // The handle of USkin object
		LPCSTR lpszSkinTextStyleResName    // The textstyle property name
		HDC hDC    // handle to the device context
		LPRECT lpTextRect    // text rectangle
		LPCSTR lpszText    // texted to be drawn,must to a null-terminated string 
	);
Parameters		:
	hUSkin 
		[in] The handle of USkin object 
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinDrawText(HUSKIN hUSkin,LPCSTR lpszSkinTextStyleResName,HDC hDC,LPRECT lpTextRect,LPCSTR lpszText);
...
ProtoType		:
	BOOL USkinSetWindowSkin(  HWND hWnd    // The handle to the window
		LPCSTR lpszSkinObjectName    // uskin object name
	);
Parameters		:
	hWnd 
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero 
*/
USKIN_API BOOL __stdcall USkinSetWindowSkin(HWND hWnd,LPCSTR lpszSkinObjectName);
...
ProtoType		:
	BOOL USkinGetWindowSkinObjectText(  HWND hWnd    // Handle of window
		LPCSTR lpszSkinObjectName    // Skin object name
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetWindowSkinObjectText(HWND hWnd,LPCSTR lpszSkinObjectName,LPTSTR lpString,UINT nMaxSize);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinSetWindowSkinObjectText(HWND hWnd,LPCSTR lpszSkinObjectName,LPCSTR lpString);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL __stdcall USkinGetWindowSkinObjectRect(HWND hWnd,LPCSTR lpszSkinObjectName,LPRECT lpRect);
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL _stdcall USkinSetWindowSkinObjectVisible(HWND hWnd,LPCSTR lpszSkinObjectName,BOOL bVisible);
...
ProtoType		:
	BOOL USkinSetWindowSkinObjectVisible(  HWND hWnd    // Handle of window
		LPCSTR lpszSkinObjectName    // SkinObject name
		BOOL bVisible    // 
	);
Parameters		:
	hUSkin 
...
Return values	:
	If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. 
*/
USKIN_API BOOL _stdcall USkinGetWindowSkinObjectVisible(HWND hWnd,LPCSTR lpszSkinObjectName,BOOL& bVisible);
